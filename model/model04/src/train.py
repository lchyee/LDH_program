"""
TimesNet 训练脚本 (Model04) - 横截面排序进化版
"""
import os
import sys
import joblib
...
class Configs:
    def __init__(self, enc_in):
        ...
        self.seq_len = 20
        self.pred_len = 0
        self.label_len = 0        # 修复 AttributeError
        self.num_class = 1
        self.enc_in = enc_in
        self.embed = 'timeF'      # 修复 DataEmbedding
        self.freq = 'd'           # 修复 DataEmbedding
        self.d_model = 64
        self.d_ff = 128
        self.e_layers = 2
        self.dropout = 0.1
...
class CrossSectionalDataset(Dataset):
    ...
    def __len__(self): return len(self.valid_dates)
...
def main():
    set_seed(42)
    print("========== 开始训练: TimesNet (Ranking Loss 进化版) ==========")
    ...
    print(f"✓ [Model04] 训练完成！最佳 epoch: {best_epoch}, 最佳验证 Loss: {best_val_loss:.4f}")
