...
def main():
    set_seed(42)
    print("========== 开始训练: DLinear (Ranking Loss 进化版) ==========")
    ...
    print(f"✓ [Model03] 训练完成！最佳 epoch: {best_epoch}, 最佳验证 Loss: {best_val_loss:.4f}")
